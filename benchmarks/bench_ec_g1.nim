...
proc main() =
  ...
  staticFor i, 0, AvailableCurves.len:
    ...
    separator()
    scalarMulUnsafeWNAFBench(ECP_ShortW_Prj[Fp[curve], G1], window = 2, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Prj[Fp[curve], G1], window = 3, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Prj[Fp[curve], G1], window = 4, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Prj[Fp[curve], G1], window = 5, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Jac[Fp[curve], G1], window = 2, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Jac[Fp[curve], G1], window = 3, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Jac[Fp[curve], G1], window = 4, MulIters)
    scalarMulUnsafeWNAFBench(ECP_ShortW_Jac[Fp[curve], G1], window = 5, MulIters)
    separator()
