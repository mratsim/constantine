...
typedef struct { banderwagon_fp x, y, z; } banderwagon_ec_jac;
...
void        ctt_banderwagon_ec_aff_ccopy(banderwagon_ec_aff* P, const banderwagon_ec_aff* Q, secret_bool ctl);
secret_bool ctt_banderwagon_ec_aff_is_on_curve(const banderwagon_fp* x, const banderwagon_fp* y);
void        ctt_banderwagon_ec_aff_neg(banderwagon_ec_aff* P, const banderwagon_ec_aff* Q);
void        ctt_banderwagon_ec_aff_neg_in_place(banderwagon_ec_aff* P);
void        ctt_banderwagon_ec_aff_cneg(banderwagon_ec_aff* P, secret_bool ctl);
...
void        ctt_banderwagon_ec_prj_neg(banderwagon_ec_prj* P, const banderwagon_ec_prj* Q);
void        ctt_banderwagon_ec_prj_neg_in_place(banderwagon_ec_prj* P);
void        ctt_banderwagon_ec_prj_cneg(banderwagon_ec_prj* P, secret_bool ctl);
