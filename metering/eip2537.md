...
bench xoshiro512** seed: 1711986204
Warmup: 0.7372 s, result 224 (displayed to avoid compiler optimizing warmup away)
...
Running on AMD Ryzen 7 PRO 7840U w/ Radeon 780M Graphics

⚠ Cycles measurements are approximate and use the CPU nominal clock: Turbo-Boost and overclocking will skew them.
i.e. a 20% overclock will be about 20% off (assuming no dynamic frequency scaling)

|                                     |                                  |                                  |                           |                              |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Multiplication                      | Fr[BLS12_381]                    | 90909090.909 ops/s               | 11 ns/op                  | 36 CPU cycles (approx)       |
| Squaring                            | Fr[BLS12_381]                    | 90909090.909 ops/s               | 11 ns/op                  | 37 CPU cycles (approx)       |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Multiplication                      | Fp[BLS12_381]                    | 47619047.619 ops/s               | 21 ns/op                  | 72 CPU cycles (approx)       |
| Squaring                            | Fp[BLS12_381]                    | 45454545.455 ops/s               | 22 ns/op                  | 72 CPU cycles (approx)       |
| Inversion                           | Fp[BLS12_381]                    | 537634.409 ops/s                 | 1860 ns/op                | 6127 CPU cycles (approx)     |
| Square Root + isSquare              | Fp[BLS12_381]                    | 94366.330 ops/s                  | 10597 ns/op               | 34906 CPU cycles (approx)    |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Multiplication                      | Fp2[BLS12_381]                   | 12987012.987 ops/s               | 77 ns/op                  | 254 CPU cycles (approx)      |
| Squaring                            | Fp2[BLS12_381]                   | 19230769.231 ops/s               | 52 ns/op                  | 173 CPU cycles (approx)      |
| Inversion                           | Fp2[BLS12_381]                   | 456621.005 ops/s                 | 2190 ns/op                | 7214 CPU cycles (approx)     |
| Square Root + isSquare              | Fp2[BLS12_381]                   | 47472.110 ops/s                  | 21065 ns/op               | 69385 CPU cycles (approx)    |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Multiplication                      | Fp12[BLS12_381]                  | 747943.156 ops/s                 | 1337 ns/op                | 4404 CPU cycles (approx)     |
| Squaring                            | Fp12[BLS12_381]                  | 1014198.783 ops/s                | 986 ns/op                 | 3248 CPU cycles (approx)     |
| Inversion                           | Fp12[BLS12_381]                  | 177367.861 ops/s                 | 5638 ns/op                | 18572 CPU cycles (approx)    |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| EC Add G1                           | ECP_ShortW_Prj[Fp[BLS12_381]]    | 2747252.747 ops/s                | 364 ns/op                 | 1202 CPU cycles (approx)     |
| EC Mixed Addition G1                | ECP_ShortW_Prj[Fp[BLS12_381]]    | 2985074.627 ops/s                | 335 ns/op                 | 1105 CPU cycles (approx)     |
| EC Double G1                        | ECP_ShortW_Prj[Fp[BLS12_381]]    | 4166666.667 ops/s                | 240 ns/op                 | 792 CPU cycles (approx)      |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| EC Add G1                           | ECP_ShortW_Jac[Fp[BLS12_381]]    | 2188183.807 ops/s                | 457 ns/op                 | 1506 CPU cycles (approx)     |
| EC Mixed Addition G1                | ECP_ShortW_Jac[Fp[BLS12_381]]    | 2747252.747 ops/s                | 364 ns/op                 | 1199 CPU cycles (approx)     |
| EC Double G1                        | ECP_ShortW_Jac[Fp[BLS12_381]]    | 4545454.545 ops/s                | 220 ns/op                 | 725 CPU cycles (approx)      |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| EC Add G2                           | ECP_ShortW_Prj[Fp2[BLS12_381]]   | 945179.584 ops/s                 | 1058 ns/op                | 3485 CPU cycles (approx)     |
| EC Mixed Addition G2                | ECP_ShortW_Prj[Fp2[BLS12_381]]   | 1033057.851 ops/s                | 968 ns/op                 | 3189 CPU cycles (approx)     |
| EC Double G2                        | ECP_ShortW_Prj[Fp2[BLS12_381]]   | 1557632.399 ops/s                | 642 ns/op                 | 2115 CPU cycles (approx)     |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| EC Add G2                           | ECP_ShortW_Jac[Fp2[BLS12_381]]   | 805152.979 ops/s                 | 1242 ns/op                | 4093 CPU cycles (approx)     |
| EC Mixed Addition G2                | ECP_ShortW_Jac[Fp2[BLS12_381]]   | 1016260.163 ops/s                | 984 ns/op                 | 3243 CPU cycles (approx)     |
| EC Double G2                        | ECP_ShortW_Jac[Fp2[BLS12_381]]   | 2028397.566 ops/s                | 493 ns/op                 | 1625 CPU cycles (approx)     |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| EC ScalarMul 255-bit G1             | ECP_ShortW_Prj[Fp[BLS12_381]]    | 17305.230 ops/s                  | 57786 ns/op               | 190335 CPU cycles (approx)   |
| EC ScalarMul 255-bit G1             | ECP_ShortW_Jac[Fp[BLS12_381]]    | 17157.956 ops/s                  | 58282 ns/op               | 191969 CPU cycles (approx)   |
| EC ScalarMul 255-bit G2             | ECP_ShortW_Prj[Fp2[BLS12_381]]   | 8830.724 ops/s                   | 113241 ns/op              | 372992 CPU cycles (approx)   |
| EC ScalarMul 255-bit G2             | ECP_ShortW_Jac[Fp2[BLS12_381]]   | 9279.020 ops/s                   | 107770 ns/op              | 354974 CPU cycles (approx)   |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Miller Loop BLS12                   | BLS12_381                        | 5607.707 ops/s                   | 178326 ns/op              | 587368 CPU cycles (approx)   |
| Final Exponentiation BLS12          | BLS12_381                        | 4699.027 ops/s                   | 212810 ns/op              | 700950 CPU cycles (approx)   |
| Pairing BLS12                       | BLS12_381                        | 2598.368 ops/s                   | 384857 ns/op              | 1267636 CPU cycles (approx)  |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |
| Hash to G1 (SSWU - Draft #14)       | BLS12_381                        | 24378.946 ops/s                  | 41019 ns/op               | 135109 CPU cycles (approx)   |
| Hash to G2 (SSWU - Draft #14)       | BLS12_381                        | 8038.585 ops/s                   | 124400 ns/op              | 409749 CPU cycles (approx)   |
| ----------------------------------- | -------------------------------- | -------------------------------- | ------------------------- | ---------------------------- |

Notes:
  - All procedures are constant-time unless mentioned otherwise (unsafe or vartime)
  - Compilers:
    Compilers are severely limited on multiprecision arithmetic.
    Constantine compile-time assembler is used by default "nimble bench_summary_bls12_381".
    GCC is significantly slower than Clang on multiprecision arithmetic due to catastrophic handling of carries.
    GCC also seems to have issues with large temporaries and register spilling.
    This is somewhat alleviated by Constantine compile-time assembler but not perfect.
    Bench on specific compiler with assembler: "nimble bench_summary_bls12_381_clang".
    Bench on specific compiler with assembler: "nimble bench_summary_bls12_381_clang_noasm".
...
|madd*(r: var ECP_ShortW_Jac[F, G]; P: ECP_ShortW_Jac[F,  ...|            64|          337156.193|           189.823|             2.966|        619.014|          9.672|
...
|prod*(r: var FF; a, b: FF; skipFinalSub: static bool = f ...|          1301|        16744317.743|            77.698|             0.060|        129.690|          0.100|
...
|prod*(r: var FF; a, b: FF; skipFinalSub: static bool = f ...|             6|        16620498.615|             0.361|             0.060|          0.594|          0.099|
|square*(r: var FF; a: FF; skipFinalSub: static bool = false)|             2|        16666666.667|             0.120|             0.060|          0.198|          0.099|
...
|madd_vartime*(r: var ECP_ShortW_Jac[F, G]; p: ECP_ShortW ...|            69|          296900.616|           232.401|             3.368|        758.835|         10.998|
|batchAffine*(affs: ptr UncheckedArray[ECP_ShortW_Aff[F,  ...|             1|           73389.109|            13.626|            13.626|         44.748|         44.748|
|scalarMulEndo_minHammingWeight_windowed_vartime*(P: var  ...|             1|            1933.436|           517.214|           517.214|       1703.460|       1703.460|
...
|prod*(r: var FF; a, b: FF; skipFinalSub: static bool = f ...|             6|        16666666.667|             0.360|             0.060|          0.594|          0.099|
|square*(r: var FF; a: FF; skipFinalSub: static bool = false)|             2|        16666666.667|             0.120|             0.060|          0.198|          0.099|
