...
func millerLoopBW6_761_naive[Name](
  ...
  basicMillerLoop(
    f, T,
    P, Q,
    pairing(Name, ate_param_1_unopt), pairing(Name, ate_param_1_unopt_isNeg)
  )
  ...
  basicMillerLoop(
    f2, T,
    P, Q,
    pairing(Name, ate_param_2_unopt), pairing(Name, ate_param_2_unopt_isNeg)
  )
...
func finalExpGeneric[Name: static Algebra](f: var Fp6[Name]) =
...
func finalExpHard_BW6_761*[Name: static Algebra](f: var Fp6[Name]) =
  ## A generic and slow implementation of final exponentiation
  ## for sanity checks purposes.
...
func millerLoopBW6_761_opt_to_debug[Name](
  ...
  template u: untyped = pairing(Name, ate_param_1_opt)
  ...
  template u: untyped = pairing(Name, ate_param_2_opt)
