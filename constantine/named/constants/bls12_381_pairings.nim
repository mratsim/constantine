...
func millerLoopAddchain*(
       ...
       Q: EC_ShortW_Aff[Fp2[BLS12_381], G2],
       P: EC_ShortW_Aff[Fp[BLS12_381], G1]
     ) {.meter.} =
  ## Miller Loop for BLS12-381 curve
  ## Computes f{u,Q}(P) with u the BLS curve parameter

  var T {.noInit.}: EC_ShortW_Prj[Fp2[BLS12_381], G2]
...
func millerLoopAddchain*(
       f: var Fp12[BLS12_381],
       Qs: ptr UncheckedArray[EC_ShortW_Aff[Fp2[BLS12_381], G2]],
       Ps: ptr UncheckedArray[EC_ShortW_Aff[Fp[BLS12_381], G1]],
       N: int
     ) {.noInline, meter.} =
  ## Generic Miller Loop for BLS12 curve
  ## Computes f{u,Q}(P) with u the BLS curve parameter

  var Ts = allocStackArray(EC_ShortW_Prj[Fp2[BLS12_381], G2], N)
...
func cycl_exp_by_curve_param_div2*(
       r: var AnyFp12[BLS12_381], a: AnyFp12[BLS12_381],
