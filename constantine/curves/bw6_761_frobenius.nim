...
const BW6_761_FrobeniusMapCoefficients* = [
  # frobenius(1) -----------------------
  [Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^0
    "0x1"),
  Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^1
  ...
  Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^2
  ...
  Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^3
  ...
  Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^4
  ...
  Fp[BW6_761].fromHex(  # SNR^((p-1)/6)^5
    "0x531dc16c6ecd27aa846c61024e4cca6c1f31e53bd9603c2d17be416c5e4426ee4a737f73b6f952ab5e57926fa701848e0a235a0a398300c65759fc45183151f2f082d4dcb5e37cb6290012d96f8819c547ba8a4000002f962140000000002b")],
  # frobenius(2) -----------------------
  [Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^0
    "0x1"),
  Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^1
    "0xcfca638f1500e327035cdf02acb2744d06e68545f7e64c256ab7ae14297a1a823132b971cdefc65870636cb60d217ff87fa59308c07a8fab8579e02ed3cddca5b093ed79b1c57b5fe3f89c11811c1e214983de300000535e7bc00000000060"),
  Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^2
    "0x531dc16c6ecd27aa846c61024e4cca6c1f31e53bd9603c2d17be416c5e4426ee4a737f73b6f952ab5e57926fa701848e0a235a0a398300c65759fc45183151f2f082d4dcb5e37cb6290012d96f8819c547ba8a4000002f962140000000002a"),
  Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^3
    "0x1"),
  Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^4
    "0xcfca638f1500e327035cdf02acb2744d06e68545f7e64c256ab7ae14297a1a823132b971cdefc65870636cb60d217ff87fa59308c07a8fab8579e02ed3cddca5b093ed79b1c57b5fe3f89c11811c1e214983de300000535e7bc00000000060"),
  Fp[BW6_761].fromHex(  # norm(SNR)^((p-1)/6)^5
    "0x531dc16c6ecd27aa846c61024e4cca6c1f31e53bd9603c2d17be416c5e4426ee4a737f73b6f952ab5e57926fa701848e0a235a0a398300c65759fc45183151f2f082d4dcb5e37cb6290012d96f8819c547ba8a4000002f962140000000002a")],
  # frobenius(3) -----------------------
  [Fp[BW6_761].fromHex(  # (SNR²)^((p-1)/6)^0
    "0x1"),
