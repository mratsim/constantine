...
|---------------|--------------|-------------------------------------------|-----------------|-------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| 0             | Magic number | Fixed bytes at the beginning of each file | 12              | Hex E28883 E28B83 E28888 E2888E                             | Unicode string "∃⋃∈∎". Read as "There exists a union of elements of proofs" Unicode: [U+2203, U+222A, U+2208, U+220E] encoded in UTF-8 | Distinguish the file format even with incorrect extension.                                                                                     |
...
| 63            | fields  | number of data fields `n`       | 1               | {n}, `n` is encoded as an 8-bit integer | `3` | Compute byte offsets and buffer(s) size |
