...
const BLS12_381_param = block:
  let u = BigInt[64].fromHex("0xd201000000010000")
  var scalarCanonical: array[(u.bits+7) div 8, byte]
  scalarCanonical.exportRawUint(u, bigEndian)
  scalarCanonical
...
func millerLoopGenericBLS12*[C: static Curve](
  ...
  for scalarByte in BLS12_381_param:
    for bit in unpack(scalarByte):
      line.line_double(T, Paff)
      f.square()
      f.mul_sparse_by_line(line)
      if bit:
...
const BLS12_381_finalexponent = block:
  let exp = BigInt[4314].fromHex("")
  var expCanonical: array[(exp.bits+7) div 8, byte]
  expCanonical.exportRawUint(exp, bigEndian)
  expCanonical

func finalExpGeneric*[C: static Curve](f: var Fp12[C]) =
  ## A generic and slow implementation of finale exponentiation
