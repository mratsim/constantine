...
const Lattice_BLS12_377_G2 = (
  ...
  # Value, isNeg
  ((BigInt[64].fromHex"0x8508c00000000001", false), # -x
   (BigInt[1].fromHex"0x1", false),                 #  1
...
const Babai_BLS12_377_G2 = (
  # Vector for Babai rounding
  # Value, isNeg
  (BigInt[193].fromHex"0x1eca0125755aed064f63abaff9084ce152979759b442f60d0", false),
  (BigInt[130].fromHex"0x3b3f7aa969fd371607f72ed32af90181f", true),
  (BigInt[67].fromhex"0x72030ba8ee9c06414", false),
