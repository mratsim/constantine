...
import
  ...
  ../../constantine/backend/elliptic/[ec_shortweierstrass_affine, ec_shortweierstrass_projective],
  ../../constantine/backend/curves/[zoo_subgroups, zoo_pairings],
  ../../constantine/backend/pairing/cyclotomic_subgroup,
