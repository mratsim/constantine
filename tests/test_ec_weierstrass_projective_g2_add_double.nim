...
rng.seed(seed)
echo "test_ec_weierstrass_projective_G2_add_double xoshiro512** seed: ", seed
...
suite "Elliptic curve in Short Weierstrass form with projective coordinates on the G2 twist":
