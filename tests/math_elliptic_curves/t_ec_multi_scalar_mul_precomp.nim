...
proc testConfig[N: static int](t, b: int, label: string, samples: int, seed: uint64) =
  echo "Test: ", label
  var rng: RngState
  rng.seed(seed)
  ...
  var precomp: PrecomputedMSM[BLS12_381_G1_Jac, N]
  precomp.init(basis[], t = t, b = b)

  echo "  Table size: ", msmPrecompSize(BLS12_381_G1_Jac, N, t, b), " points"
